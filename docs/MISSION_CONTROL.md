...
#
# 마지막 업데이트: 2026-03-18
# 업데이트한 사람: Antigravity Agent (차량위치관제 시스템 구축 - Phase 1~5 완료)
...
- [2026-03-18] **아산지점 배차판 오늘 날짜 선택 오류 수정**: 서버/클라이언트 타임존 차이를 KST 기준으로 보정.
- [2026-03-17] **경로 탐색 터미널 좌표/행정동 교정**: 14곳 터미널 실제 행정동+카카오맵 좌표 반영.
- [2026-03-12] **실적현황 리뉴얼**: 실기록 기반 재무 지표 + 인증서 갤러리 7종 구축.
