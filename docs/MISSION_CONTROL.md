...
#
# 마지막 업데이트: 2026-03-02
# 업데이트한 사람: Antigravity Agent (모바일 고밀도 UI 최적화)
...
- [2026-03-02] 관리자(권한/로그/대시보드) 및 인트라넷 각종 페이지 데스크탑 가로 폭 무제한 확장 및 우상단 컨트롤 버튼 구조 통일
- [2026-03-02] 아산 배차판 기준의 고밀도 테이블 레이아웃 및 여백 규칙 전면 도입 (테이블 셀 padding 축소 등)
