...
| 월간실적 current | 1년 3개월 | 원본 Excel NAS 보관 | 운영 임시 원장. 필요 시 전체 리셋 후 새 월간자료를 다시 수집 |
| 연간실적 원장 | 2026년 이후 연도별 누적 추적, 최신 fix 스냅샷 | 원본 Excel NAS 보관 | 사람이 정리한 확정 Excel을 별도 source로 추가. 월간자료를 자동 이월하지 않음 |
