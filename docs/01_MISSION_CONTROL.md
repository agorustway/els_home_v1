# ELS MISSION CONTROL v4.3.17
> 마지막 업데이트: 2026-03-31 06:15 (KST)

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.3.17` (Build 316)
- **최근 업데이트**: 2026-03-31
- **상태**: 🟢 배포 완료 — 앱 종료 시 알림바 메시지 잔상 버그 수정 및 설정 UI 여백 보완
- **APK 다운로드**: [els_driver.apk](https://www.nollae.com/apk/els_driver.apk)
- **설정 파일**: `web/public/apk/version.json` (v4.3.17)
