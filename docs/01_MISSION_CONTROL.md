# ELS MISSION CONTROL (v5.14.146 / APK v5.11.29)

> 최신 업데이트: 상세배차 포트코드는 GLAPS 항목매핑 값이 없으면 원본 포트값(USSAV 등)을 기본 표시해 임의 작성값 정정 대상을 바로 볼 수 있게 했습니다.
...
- [x] v5.14.64-146: 월간/연간/종합실적 분석, 행사일정/공휴일, 선적 job, 배차판 DB/WEB 셀, Android 오버레이/GPS/관제 통계, 연락처 입력/표기 안정화, 통합 배차판 선적 컬럼 표시, GLAPS 상세배차/마스터 원장 1.5단계, 배차판 원본 엑셀 WEB 컬럼 분리
