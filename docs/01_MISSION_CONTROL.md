...
- [x] 🌤️ 기상 대시보드 리팩토링 및 성능 최적화 (2026-04-10)
    - [x] 3D PNG 제거 및 이모지 대체 (로딩 속도 개선)
    - [x] API 호출 통합 (11개 → 1개) 및 캐싱 적용
    - [x] 항만 기상 데이터 실시간 연동 (Marine API)
    - [x] 기상특보 배너 자동 생성 로직 구현
- [x] 📱 모바일 UI 가로 넘침 문제 해결 (2026-04-10)
    - [x] 차량 관제 상세 패널 (500px → 100%) 수정
    - [x] 사이드바 데스크탑 오버레이 버그 수정
    - [x] 날씨 페이지 및 메인 레이아웃 overflow 제약 추가
