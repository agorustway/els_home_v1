# ELS MISSION CONTROL (v5.14.85 / APK v5.11.24)

> 최신 업데이트: ELS Bot 자동 로그인 실패가 계정 잠금으로 번지지 않도록 계정 기준 3회 하드캡과 보호모드를 적용했습니다.
...
- [x] v5.14.85: ELS Bot 자동 로그인 3회 하드캡과 ID/PW 실패 보호모드
