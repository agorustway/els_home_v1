# ELS MISSION CONTROL (v5.14.132 / APK v5.11.29)

> 최신 업데이트: 종합실적 구성·차량 비교 카드 제목을 `당사 / 협력사 비교`로 바꿔 화면 의미를 더 직접적으로 정리했습니다.
...
- [x] v5.14.64-132: 월간/연간/종합실적 분석, 행사일정/공휴일, 선적 job, 배차판 DB/WEB 셀, Android 오버레이/GPS/관제 통계 안정화
