...
| 항목 | 내용 | 비고 |
| :--- | :--- | :--- |
| **현재 버전** | `v4.9.91` | **Driver App Critical Failure Persistence** |
| **상태** | 🔴 미해결 (v4.9.27) | 드라이버 앱 ID 누락 오류 지속 (v4.9.27 배포 후에도 재발) |
...
7.  **[CRITICAL]** 드라이버 앱 "ID 누락" 현상 근본 원인 파악 및 해결 (v4.9.27 기준 방어 로직 작동 안 함 - 통신 무결성 전면 조사 필요)
