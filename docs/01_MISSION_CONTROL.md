# ELS MISSION CONTROL v4.3.12
> 마지막 업데이트: 2026-03-31 05:20 (KST)

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.3.12` (Build 311)
- **최근 업데이트**: 2026-03-31
- **상태**: 🟢 배포 완료 — 설정 페이지 버튼 시인성 보강 및 레이아웃 최적화
- **APK 다운로드**: [els_driver.apk](https://www.nollae.com/apk/els_driver.apk)
- **설정 파일**: `web/public/apk/version.json` (v4.3.12)

### 🎯 주요 마일스톤
- [x] **v4.3.12**: [UI/UX] 설정 하단 버튼 높이 상향(38px->42px), 패딩 보강, 1페이지 뷰 무스크롤 유지 최적화
