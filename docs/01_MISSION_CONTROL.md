# ELS MISSION CONTROL v4.3.09
> 마지막 업데이트: 2026-03-31 04:50 (KST)

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.3.09` (Build 308)
- **최근 업데이트**: 2026-03-31
- **상태**: 🟢 배포 완료 — 네이티브 실시간 모드 폴링 통신 구조 보완 및 UI 버튼 크기 통일
- **APK 다운로드**: [els_driver.apk](https://www.nollae.com/apk/els_driver.apk)
- **설정 파일**: `web/public/apk/version.json` (v4.3.09)
