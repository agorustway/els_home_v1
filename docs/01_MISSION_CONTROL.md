...
> 마지막 업데이트: 2026-04-04 21:45 (KST)

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.3.29` (Mobile) / `v4.5.26` (Unified Web/Backend)  
- **최근 업데이트**: 2026-04-04
- **상태**: 🚀 드라이버 앱 지도 탭 하단 통합 및 레이아웃 최적화 배포 (v4.3.29)
...
## ✅ 주요 마일스톤 (Milestones)
- [x] **2026-04-04**: [APP] v4.3.29 - 지도 탭 하단 바 통합, 뒤로가기 제거, 네이버 지도 로딩 안전성 강화
