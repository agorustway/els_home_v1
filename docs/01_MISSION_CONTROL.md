# ELS MISSION CONTROL v4.5.9
> 마지막 업데이트: 2026-04-04 08:30 (KST)

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.3.26` (Mobile) / `v4.5.9` (Unified Web/Backend)
- **최근 업데이트**: 2026-04-04
- **상태**: 🚀 컨테이너 이력조회 엑셀 서식 복구(openpyxl 2시트), 로딩 UI 진행률 표시 개선 완료.
- **APK 다운로드**: [els_driver.apk](https://www.nollae.com/apk/els_driver.apk)
- **설정 파일**: `web/public/apk/version.json` (v4.3.26)

- [x] **2026-04-04**: [BOT/FIX] 컨테이너 이력조회 엑셀 서식 완전 복구 - openpyxl 기반 2시트(최신이력_No1/전체이력), 맑은 고딕 10pt, 수입=빨강/반입=파랑 색상, 틀고정, 자동필터/열너비 (v4.5.9)
- [x] **2026-04-04**: [WEB/UX] 조회 대기/진행 중 행에 인라인 스피너 + X/N 완료 진행률 표시 추가 (v4.5.9)
- [x] **2026-04-03**: [WEB] 차량 관제(Vehicle Tracking) 모바일 화면 구조 개선 - 목록 바텀 시트 구현 및 마커 실시간 추적 패닝 로직 안정화 (v4.5.8)
- [x] **2026-04-03**: [WEB] 컨테이너 이력조회 창 가로 스크롤 넘침 불량 수정 및 NAS 자료실 복수 파일/폴더 선택 시 ZIP 다운로드 로직 분리 (v4.5.8)
