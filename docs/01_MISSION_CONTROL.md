# ELS MISSION CONTROL (v5.14.151 / APK v5.11.29)

> 최신 업데이트: 전역/인트라넷 메뉴의 데스크톱·모바일 높이와 여백을 보정해 같은 폰트 크기에서도 화면 밀도를 높였다.
...
- 같은 URL 모바일 390x844에서 헤더 56px, 임직원 헤더 40px, 사이드바 244px, 메뉴 항목 36px 확인 후 서버 종료.
