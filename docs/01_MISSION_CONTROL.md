# ELS MISSION CONTROL v4.3.20
> 마지막 업데이트: 2026-03-31 11:33 (KST)

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.3.20` (Build 319)
- **최근 업데이트**: 2026-03-31
- **상태**: 🟢 배포 완료 — 정차 배터리 최적화 · 일시정지 주소 유지 · 복귀 GPS 깜빡임 방지
- **APK 다운로드**: [els_driver.apk](https://www.nollae.com/apk/els_driver.apk)
- **설정 파일**: `web/public/apk/version.json` (v4.3.20)

### 🎯 주요 마일스톤
- [x] **v4.3.20**: [OPT] 정차 180초 + 자이로 스킵(배터리 절감) · [FIX] 일시정지 한글주소 유지 · [UX] 복귀 GPS 깜빡임 3s Grace Period
- [x] **v4.3.19**: [FIX×4] 108초 딜레이·가변주기·자이로 민감도·종료탭 알림 잔상 전량 해소
