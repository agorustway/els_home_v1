# ELS MISSION CONTROL v4.3.23
> 마지막 업데이트: 2026-03-31 14:10 (KST)

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.3.23` (Build 322)
- **최근 업데이트**: 2026-03-31
- **상태**: 🟢 배포 완료 — 종료 탭 제거 및 상단 뒤로가기(<) 버튼 추가 (고스트 알림 현상 완전 해결)
- **APK 다운로드**: [els_driver.apk](https://www.nollae.com/apk/els_driver.apk)
- **설정 파일**: `web/public/apk/version.json` (v4.3.23)

### 🎯 주요 마일스톤
- [x] **v4.3.23**: [UI/UX] 종료 탭 제거 및 상단 뒤로가기(<) 버튼 추가. App.minimizeApp()을 통한 부드러운 종료 구현.
- [x] **v4.3.22**: [HOTFIX] 종료 버튼 누를 때 알림창 생기는 버그 완전 해결 시도 (EXPLICIT_EXIT 방식)
