# ELS MISSION CONTROL v4.1.36
> 마지막 업데이트: 2026-03-28 16:20

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.1.36` (Build 82)
- **최근 업데이트**: 2026-03-28
- **상태**: 🟢 핫픽스 배포 중 (UI 겹침 및 업데이트 루프 해결)
- **APK 다운로드**: [els_driver.apk](https://www.nollae.com/apk/els_driver.apk)
- **설정 파일**: `web/public/apk/version.json` (v4.1.36 동기화 완료)

### 🎯 주요 마일스톤
- [x] **v4.1.36**: 핫픽스 (업데이트 루프 제거, 초기 화면 UI 구조 전면 복구, 갤러리 노출 차단)
