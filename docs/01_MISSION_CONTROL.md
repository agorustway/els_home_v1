...
> 마지막 업데이트: 2026-04-04 21:25 (KST)

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.3.28` (Mobile) / `v4.5.26` (Unified Web/Backend)  
- **최근 업데이트**: 2026-04-04
- **상태**: 🚀 드라이버 앱 네이버 지도 인증 우회 및 버전 갱신 완료 (v4.3.28)
...
## ✅ 주요 마일스톤 (Milestones)
- [x] **2026-04-04**: [APP] v4.3.28 - 네이버 지도 API 인증 오류 우회 조치 (Origin 변경) 및 하드코딩 버전 UI 갱신
