...
> 마지막 업데이트: 2026-04-04 21:13 (KST)

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.3.27` (Mobile) / `v4.5.26` (Unified Web/Backend)  
- **최근 업데이트**: 2026-04-04
- **상태**: 🚀 드라이버 앱 전체화면 지도 및 백그라운드 푸시 알림 배포 완료 (v4.3.27 Hotfix)
...
## ✅ 주요 마일스톤 (Milestones)
- [x] **2026-04-04**: [APP] v4.3.27 - 전체화면 지도 탭 도입 및 백그라운드 긴급알림 안드로이드 푸시 연동 (Hotfix 포함)
