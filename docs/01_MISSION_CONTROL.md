# ELS MISSION CONTROL v4.3.19
> 마지막 업데이트: 2026-03-31 10:52 (KST)

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.3.19` (Build 318)
- **최근 업데이트**: 2026-03-31
- **상태**: 🟢 배포 완료 — 필드테스트 버그 3종 수정 + 종료 탭 알림창 잔상 완전 해소
- **APK 다운로드**: [els_driver.apk](https://www.nollae.com/apk/els_driver.apk)
- **설정 파일**: `web/public/apk/version.json` (v4.3.19)

### 🎯 주요 마일스톤
- [x] **v4.3.19**: [FIX×4] 108초 딜레이 버그·가변주기 버그·자이로 민감도·종료탭 알림 잔상 전량 해소
- [x] **v4.3.18**: [HOTFIX] 서비스 미구동 상태에서 종료 시 고스트 알림 현상 해결
