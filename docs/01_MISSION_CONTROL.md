# ELS MISSION CONTROL v4.3.16
> 마지막 업데이트: 2026-03-31 06:05 (KST)

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.3.16` (Build 315)
- **최근 업데이트**: 2026-03-31
- **상태**: 🟢 배포 완료 — 설정 페이지 UI 38px 복구 및 메뉴 그룹화 '설정' 라벨 추가
- **APK 다운로드**: [els_driver.apk](https://www.nollae.com/apk/els_driver.apk)
- **설정 파일**: `web/public/apk/version.json` (v4.3.16)

### 🎯 주요 마일스톤
- [x] **v4.3.16**: [UI/UX] 설정 페이지 주요 필드/버튼 38px 복구, 하단 버튼 그룹 '설정' 라벨 추가 및 여백 조정
- [x] **v4.3.15**: [UI/UX] 설정 페이지 필드(36px) 및 하단 버튼(38px) 추가 축소, 공지 탭 필터 버튼 높이 상향(36px) 및 폰트 확대
