# ELS MISSION CONTROL v4.3.10
> 마지막 업데이트: 2026-03-31 04:58 (KST)

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.3.10` (Build 309)
- **최근 업데이트**: 2026-03-31
- **상태**: 🟢 배포 완료 — UI/UX 리뉴얼 (버튼/입력창 높이 통일 및 헤더/상태 칸 여백 확대)
- **APK 다운로드**: [els_driver.apk](https://www.nollae.com/apk/els_driver.apk)
- **설정 파일**: `web/public/apk/version.json` (v4.3.10)
