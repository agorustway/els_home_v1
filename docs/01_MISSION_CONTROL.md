# ELS MISSION CONTROL v4.3.15
> 마지막 업데이트: 2026-03-31 05:48 (KST)

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.3.15` (Build 314)
- **최근 업데이트**: 2026-03-31
- **상태**: 🟢 배포 완료 — 설정 페이지 UI 정밀 축소 및 공지 카테고리 버튼 시인성 보강
- **APK 다운로드**: [els_driver.apk](https://www.nollae.com/apk/els_driver.apk)
- **설정 파일**: `web/public/apk/version.json` (v4.3.15)

### 🎯 주요 마일스톤
- [x] **v4.3.15**: [UI/UX] 설정 페이지 입력 필드(36px) 및 하단 버튼(38px) 추가 축소로 1페이지 뷰 안정화, 공지 탭 필터 버튼 높이 상향(36px) 및 폰트 확대
