# ELS MISSION CONTROL v4.3.14
> 마지막 업데이트: 2026-03-31 05:35 (KST)

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.3.14` (Build 313)
- **최근 업데이트**: 2026-03-31
- **상태**: 🟢 배포 대기 — 설정 페이지 필드 높이 추가 축소 및 공지 탭 필터 버튼 개선
- **APK 다운로드**: [els_driver.apk](https://www.nollae.com/apk/els_driver.apk)
- **설정 파일**: `web/public/apk/version.json` (v4.3.14)
