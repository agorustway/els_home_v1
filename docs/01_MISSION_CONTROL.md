# ELS MISSION CONTROL v4.5.21
> 마지막 업데이트: 2026-04-04 20:29 (KST)

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.3.26` (Mobile) / `v4.5.21` (Unified Web/Backend)  
- **최근 업데이트**: 2026-04-04
- **상태**: 🚀 실시간 마커 Ref 분리 및 상세창 연동 안정화 완결 (v4.5.21)
...
## 📋 최근 변경 (v4.5.21 — 2026-04-04)
- **실시간 마커 안정화 (v4.5.21)**:
  - `liveMarkersRef` 도입으로 운영 차량 마커와 상세 경로 마커를 완전히 분리.
  - 차량 상세 조회(리스트/마커 클릭) 시에도 주 지도의 다른 실시간 마커들이 계속 유지되도록 버그 수정.
- **주 지도 경로 정리 (v4.5.19)**:
...
---
*최종 갱신일: 2026-04-04 (by Antigravity AI v4.5.21)*
