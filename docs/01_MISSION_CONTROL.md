# ELS MISSION CONTROL v4.3.22
> 마지막 업데이트: 2026-03-31 14:05 (KST)

## 📦 최신 배포 정보 (Release)
- **현재 버전**: `v4.3.22` (Build 321)
- **최근 업데이트**: 2026-03-31
- **상태**: 🟢 배포 완료 — 종료 버튼 클릭 시 알림바 버그 완전 해결 (EXPLICIT_EXIT 플래그 방식)
- **APK 다운로드**: [els_driver.apk](https://www.nollae.com/apk/els_driver.apk)
- **설정 파일**: `web/public/apk/version.json` (v4.3.22)

### 🎯 주요 마일스톤
- [x] **v4.3.22**: [HOTFIX] 종료 버튼 누를 때 알림창 생기는 버그 완전 해결 (EXPLICIT_EXIT 플래그 방식 도입)
- [x] **v4.3.21**: [HOTFIX] 자이로/가속도 센서 6km/h 미만 킬스위치 추가
