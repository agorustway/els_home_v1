# ELS MISSION CONTROL (v5.14.307 / APK v5.11.29)

> 최신 업데이트: 안전운임 고시해석(위키트리)을 리스트 3개·상세 7개 구조로 재구성해 1차 고시, 1차 추가 운영지침, 1차-운영지침 해석을 원문 위치와 함께 추적한다.
...
- **v5.14.305**: 안전운임 관련 법령·고시 안내 모달/모바일 전용 페이지의 잘림을 보정하고, 산정 전 확인·장별 핵심 포인트를 추가했다.
