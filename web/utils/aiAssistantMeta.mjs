export const AI_ASSISTANT_VERSION = 'v5.14.157';
...
export function getAiAssistantIntroMessage() {
  return [
    ...
    '아산 배차판은 branch_dispatch의 도표형 스키마를 동적으로 읽어 오더 수량, 실제 배차 수량, 상차지역, 셀 메모 시간을 구분합니다.',
    '',
...
export function getAiAssistantGuideSections() {
  return [
    {
      title: '아산 배차판 DB 조회',
      description: 'Supabase branch_dispatch 누적자료를 기준으로 도표형 배차판을 읽습니다.',
      examples: [
        '오늘 아산 배차 총 몇 대야?',
...
export function getAiSystemCapabilitySummary() {
  return [
    '## 현재 ELS AI 실제 연결 범위',
    '- 사내 DB: 연락처, 게시글/업무보고, 작업지, 업무자료실, 차량 운행/위치, 아산 배차판 branch_dispatch.',
    ...
    '- 아산 배차판: 날짜/시간/상차지역/업체명 질문을 동적으로 해석하고, 오더 수량과 실제 배차 수량을 구분한다.',
