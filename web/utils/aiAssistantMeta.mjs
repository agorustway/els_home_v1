export const AI_ASSISTANT_VERSION = 'v5.14.210';
...
export function getAiAssistantIntroMessage() {
  return [
    ...
    '아산 배차판·상세배차·변동내역·GLAPS코드·선적관리는 Supabase 운영 DB를 읽어 답변합니다.',
    '',
...
export function getAiSystemCapabilitySummary() {
  return [
    '## 현재 ELS AI 실제 연결 범위',
    '- 사내 DB: 연락처, 게시글/업무보고, 작업지, 업무자료실, 차량 운행/위치, 아산 배차판/상세배차/변동내역/GLAPS/선적관리.',
    ...
    '- 아산 운영 DB: 날짜/시간/상차지역/업체명 질문을 동적으로 해석하고, 상세배차/변동내역/GLAPS코드/선적관리도 DB 기준으로 검색한다.',
