...
test('GLAPS 항목별 수정양식은 운송경로와 매핑 항목을 다시 업로드할 수 있게 읽는다', () => {
  const sheets = [
    ...
    },
    {
      name: '항목매핑_수정양식',
      rows: [
        ['id', 'alias_type', '배차판 매칭용', 'els_name', 'glaps_name', 'glaps_code', 'review_status', 'review_note', '수정출처', '수정일시', '삭제(Y)'],
        ['22222222-2222-2222-2222-222222222222', 'waypoint', '모비스 친환경센터', '모비스친환경센터', '모비스 친환경센터', '', '조정필요', '확인', '업로드수정', '2026-05-24', 'Y'],
      ],
    },
  ];
