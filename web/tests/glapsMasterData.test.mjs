  ...
  const parsed = parseGlapsMasterSheets([
    {
      name: '운송경로',
      rows: [
        ['화주사', '운송경로코드', '운송경로명', '경유지', '경유지(ELS)', '경유지코드', '비고'],
        ['B000034432', 'MBS00015', '부산신항 모비스 AS천안수출물류센터 부산항', '모비스 AS천안수출물류센터', '모비스AS천안', 'S013_EZN', ''],
  ...
  const sheets = [
    {
      name: '운송경로_수정양식',
      rows: [
        ['id', 'shipper_code', 'route_code', 'route_name', 'start_location_name', 'waypoint_name', 'waypoint_els_name', 'destination_name', 'review_status', 'review_note', '수정출처', '수정일시', '삭제(Y)'],
        ['11111111-1111-1111-1111-111111111111', 'B000034432', 'MBS00015', '부산신항 모비스 AS천안수출물류센터 부산항', '부산신항', '모비스 AS천안수출물류센터', '모비스AS천안', '부산항', 'ready', '', '웹수정', '2026-05-24', ''],
      ],
    },
    {
      name: '항목매핑_수정양식',
  ...
  const routeRows = parseGlapsRouteTemplateSheets([
    {
      ...
      rows: [
        ['GLAPS 운송경로 수정양식'],
        ['상세배차 매칭 기준: 화주사코드 + 상차지 + 경유지(ELS) + 하차지(선적). 기존 GLAPS 운송경로코드를 도출하기 위한 원장 보정용입니다.'],
        GLAPS_ROUTE_TEMPLATE_HEADERS,
        [uuid, 'KR10', '부산신항', 'KCC글라스', 'S013_M12', '부산신항', 'KCC글라스', '부산신항KCC글라스부산신항', 'GLC0035', '확정', '', '웹수정', '2026-05-24', ''],
      ],
    },
  ]);
