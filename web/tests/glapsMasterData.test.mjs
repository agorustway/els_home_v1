  ...
  const parsed = parseGlapsMasterSheets([
    {
      name: '운송경로',
      rows: [
        ['화주사', '운송경로코드', '운송경로명', '경유지', '경유지(ELS)', '비고'],
        ['B000034432', 'MBS00015', '부산신항 모비스 AS천안수출물류센터 부산항', '모비스 AS천안수출물류센터', '모비스AS천안', ''],
  ...
  const routeRows = parseGlapsRouteTemplateSheets([
    {
      ...
      rows: [
        ...
        GLAPS_ROUTE_TEMPLATE_HEADERS,
        [uuid, 'KR10', '부산신항', 'KCC글라스', '부산신항', 'KCC글라스', '부산신항KCC글라스부산신항', 'GLC0035', '확정', '', '웹수정', '2026-05-24', ''],
      ],
    },
  ]);
