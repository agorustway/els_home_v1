  ...
  const routeRows = parseGlapsRouteTemplateSheets([
    {
      ...
      rows: [
        ['GLAPS 운송경로 수정양식'],
        ['상세배차 매칭 기준: 상차지 + 경유지(ELS) + 하차지(선적). 기존 GLAPS 운송경로코드를 도출하기 위한 원장 보정용입니다.'],
        GLAPS_ROUTE_TEMPLATE_HEADERS,
        [uuid, '부산신항', 'KCC글라스', '부산신항', 'KCC글라스', '부산신항KCC글라스부산신항', 'GLC0035', '확정', '', '웹수정', '2026-05-24', ''],
      ],
    },
  ]);
