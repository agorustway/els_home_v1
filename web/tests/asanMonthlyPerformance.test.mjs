...
test('아산 월간실적 화면은 파일 설정 저장 후 자동 동기화와 이월 월 슬롯을 제공한다', () => {
  ...
  assert.match(component, /isSelected: item\.scopeKey === activeAnalysisDayValue/);
  assert.match(component, /highlightKey=\{analysisScope === ANALYSIS_SCOPE_DAY \? activeAnalysisDayValue : ''\}/);
