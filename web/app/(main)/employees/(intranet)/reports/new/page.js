...
export default function NewReportPage() {
    ...
    const [reportKind, setReportKind] = useState('daily'); // 기본값: 일일
        ...
        try {
            ...
            const res = await fetch('/api/board', {
                ...
                body: JSON.stringify({
                    ...
                    board_type: 'report',
                    report_kind: reportKind, // 필터링을 위한 핵심 데이터
        ...
        <div className={styles.container}>
            ...
            <div className={styles.editorCard}>
                <form onSubmit={handleSubmit}>
                    <div className={styles.metaGridWide}>
                    ...
                    <div className={styles.formGroup}>
                        ...
                        <input type="text" value={title} onChange={(e) => setTitle(e.target.value)} placeholder="제목을 입력하세요" className={styles.input} required />
                    </div>
                    <div className={styles.formGroup}>
                        <label className={styles.label}>내용</label>
                        <textarea value={content} onChange={(e) => setContent(e.target.value)} placeholder="보고 내용을 입력하세요" className={styles.textarea} required />
                    </div>
