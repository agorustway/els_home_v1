 ...
 */
import { Store, State, BASE_URL } from './store.js?v=487';
import { smartFetch, Emergency } from './bridge.js?v=487';
import { startRealtimeMode, stopRealtimeMode } from './gps.js?v=487';
