 ...
 */
import { State, BASE_URL } from './store.js?v=5133';
import { smartFetch, remoteLog } from './bridge.js?v=5133';
import { showToast } from './utils.js?v=5133';
import { showScreen } from './nav.js?v=5133';
import { filterRouteLocations, prepareLiveTrips } from './locationFilter.js?v=5133';
...
export async function closeMap() {
  ...
  try {
    const { loadCurrentTrip } = await import('./trip.js?v=5133');
