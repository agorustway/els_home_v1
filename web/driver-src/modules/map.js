 ...
 */
import { State, BASE_URL } from './store.js?v=5168';
import { smartFetch, remoteLog } from './bridge.js?v=5168';
import { showToast } from './utils.js?v=5168';
import { showScreen } from './nav.js?v=5168';
import { filterRouteLocations, haversineKm, prepareLiveTrips } from './locationFilter.js?v=5168';
import { contractTypeLabel, filterTripsForMapVisibility, isOwnVehicleTrip } from './cargoOptions.js?v=5168';
import { startMapForegroundTracking, stopMapForegroundTracking } from './gps.js?v=5168';
...
export async function closeMap() {
  ...
  try {
    const { loadCurrentTrip } = await import('./trip.js?v=5168');
