...
import { smartFetch, remoteLog } from './bridge.js?v=5104';
import { showToast } from './utils.js?v=5104';
import { showScreen } from './nav.js?v=5104';
import { filterRouteLocations, prepareLiveTrips } from './locationFilter.js?v=5104';
...
export async function closeMap() {
  ...
  try {
    const { loadCurrentTrip } = await import('./trip.js?v=5104');
