 ...
 */
import { State, BASE_URL } from './store.js?v=5100';
import { smartFetch, remoteLog } from './bridge.js?v=5100';
import { showToast } from './utils.js?v=5100';
...
export async function closeMap() {
  ...
  try {
    const { loadCurrentTrip } = await import('./trip.js?v=5100');
