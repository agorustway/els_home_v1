 ...
 */
import { State, BASE_URL } from './store.js?v=4927';
import { smartFetch, remoteLog } from './bridge.js?v=4927';
import { showToast } from './utils.js?v=4927';
...
export async function closeMap() {
  ...
  try {
    const { loadCurrentTrip } = await import('./trip.js?v=4927');
