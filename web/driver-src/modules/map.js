...
import { smartFetch, remoteLog } from './bridge.js?v=5131';
import { showToast } from './utils.js?v=5131';
import { showScreen } from './nav.js?v=5131';
import { filterRouteLocations, prepareLiveTrips } from './locationFilter.js?v=5131';
...
export async function closeMap() {
  ...
  try {
    const { loadCurrentTrip } = await import('./trip.js?v=5131');
