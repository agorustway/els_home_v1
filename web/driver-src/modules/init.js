 ...
 */
import { Store, State, AppConfig } from './store.js?v=5167';
import { Overlay, remoteLog } from './bridge.js?v=5167';
import { showScreen } from './nav.js?v=5167';
import {
  updatePermStatuses, permStatuses, setupPermNav, requestAllPerms,
} from './permissions.js?v=5167';
import { applyProfileToUI } from './profile.js?v=5167';
import { loadCurrentTrip, registerBackHandler } from './trip.js?v=5167';
import { startGPS, stopGPS, onGpsUpdate, lastGpsTimestamp } from './gps.js?v=5167';
import { loadNotices } from './notice.js?v=5167';
import { startEmergencyPoll, pollEmergency } from './emergency.js?v=5167';
import { checkUpdate } from './update.js?v=5167';
import { openMap } from './map.js?v=5167';
import { loadLogs } from './log.js?v=5167';
        ...
        CapApp.addListener('appStateChange', async ({ isActive }) => {
          ...
          if (isActive) {
            ...
            if (State.trip.status === 'driving') {
              ...
              const { gpsWatchId: currentWatchId } = await import('./gps.js?v=5167');
              if (!currentWatchId) {
                ...
                navigator.geolocation.getCurrentPosition(
                  pos => {
                    ...
                    onGpsUpdate(pos, false, State.trip.id, null, { source: 'app_resume' });
                    remoteLog(`포그라운드 복귀 후 UI 갱신용 GPS 수신 성공`, 'GPS_RESUME_OK');
                  },
