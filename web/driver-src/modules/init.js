 ...
 */
import { Store, State, AppConfig } from './store.js?v=5163';
...
} from './permissions.js?v=5163';
import { applyProfileToUI } from './profile.js?v=5163';
import { loadCurrentTrip, registerBackHandler } from './trip.js?v=5163';
import { startGPS, stopGPS, onGpsUpdate, lastGpsTimestamp } from './gps.js?v=5163';
import { loadNotices } from './notice.js?v=5163';
import { startEmergencyPoll, pollEmergency } from './emergency.js?v=5163';
import { checkUpdate } from './update.js?v=5163';
import { openMap } from './map.js?v=5163';
import { loadLogs } from './log.js?v=5163';
        ...
        CapApp.addListener('appStateChange', async ({ isActive }) => {
          ...
          if (isActive) {
            ...
            if (State.trip.status === 'driving') {
              ...
              const { gpsWatchId: currentWatchId } = await import('./gps.js?v=5163');
              if (!currentWatchId) {
