...
import { Overlay, smartFetch, remoteLog } from './bridge.js?v=5157';
import {
  startGPS, stopGPS,
  startTripStatusTimer, updateTripStatusLine, onGpsUpdate,
} from './gps.js?v=5157';
import { GENERAL_TRANSPORT_TYPES } from './cargoOptions.js?v=5157';
...
async function _recordTripEndMarker(tripId) {
  const gpsModule = await import('./gps.js?v=5157');
