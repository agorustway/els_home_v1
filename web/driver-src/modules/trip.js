 ...
 */
import { Store, State, BASE_URL } from './store.js?v=5170';
import { Overlay, smartFetch, remoteLog } from './bridge.js?v=5170';
import {
  startGPS, stopGPS,
  startTripStatusTimer, updateTripStatusLine, onGpsUpdate,
} from './gps.js?v=5170';
import { GENERAL_TRANSPORT_TYPES } from './cargoOptions.js?v=5170';
...
async function _recordTripEndMarker(tripId) {
  const gpsModule = await import('./gps.js?v=5170');
